...
const ViewData = () => {
  ...
  return (
    <>
        ...
        <div className="w-[90vw] max-h-[85v] rounded-lg overflow-y-auto shadow-lg">
                            ...
                            <tr key={user.id}>
                                ...
                                <td className="flex p-5 justify-center items-center">
                                    <div className="flex justify-between w-52 p-2">
                                        <Link to={`/edit/${user.id}`} className="bg-green-500 rounded-md py-2 px-6
                                        hover:bg-green-900">

                                            edit
                                        </Link>
                                        <button className="bg-red-500 rounded-md py-2 px-6 hover:bg-red-800"
